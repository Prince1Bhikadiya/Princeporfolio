...
export const serviceData = [
  ...
  
  {
    icon: <RxPencil2 />,
    title: 'Data Science',
    description: 'Agile development of predictive models and algorithms',
  },
  {
    icon: <RxDesktop />,
    title: 'Development',
    description: 'Tailored software solutions for diverse business needs',
  },
  {
    icon: <RxPencil2 />,
    title: 'Design',
    description: 'Responsive: Quickly adapting to changing requirements.',
  },
  {
    icon: <RxRocket />,
    title: 'Application ',
    description: 'Creating innovative, user-friendly applications tailored to your unique needs and goals.',
  },
];
// import swiper react 
