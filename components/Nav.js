    ...
    >
      {navData.map((link, index) => {
        ...
        >
          ...
          {/*tooltip*/}
          <div className='absolute pr-14 right-0 hidden xl:group-hover:flex rounded-[30px] '>
           <div className='bg-white relative flex text-primary items-center p-[6px] round-[30px]'>
            <div className='text-[12px] leading-none font-semibold capitalize'>
                 {link.name}
            </div>
            {/*triangle*/}
            <div className='border-solid border-l-white border-l-8  border-y-transparent border-y-[6px] 
              border-r-0 absolute -right-5'>
              </div>
